...
| # | Item | Owner |
|---|---|---|
| 1 | Live model: **decided**, `typesafe/jev-1.13` (founder, 2026-09-26; section 7.1). Still open: the budget (internal D-09, Proposed, not authorized); soft-threshold behaviour with no secondary model; whether to call the Decisions API on the `alpha` path or `/api/v1/systemone` | CTO + founder |
